...
//    public class ViewBViewModel : BasePlatformRegionViewModel
//    {
...
//        public ViewBViewModel(PlatformWpfAppContext appContext, IEventAggregator eventAggregator, IRegionManager regionManager, IWpfDeviceRequestService deviceRequestService) : base(appContext, eventAggregator, regionManager, deviceRequestService)
//        {
//            Task.Run(() =>
//            {
...
//                while (true)
//                {
//                    TitleMessage = string.Format("{0} - [ {1} ]", nameof(ViewBViewModel), DateTime.Now);
