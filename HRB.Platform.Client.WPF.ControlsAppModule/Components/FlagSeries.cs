...
//namespace HRB.Platform.Client.WPF.ControlsAppModule.Components
//{
//    public sealed class FlagSeries : ItemsSeries
//    {
//        /// <summary>
...
//        public FlagSeries()
//        {
//            this.Values = new List<KeyValuePair<double, OxyImage>>();
...
//        public List<KeyValuePair<double, OxyImage>> Values { get; private set; }
...
//            {
//                if (double.IsNaN(v.Key) || v.Key < this.XAxis.ActualMinimum || v.Key > this.XAxis.ActualMaximum)
//                {
//                    continue;
//                }

//                double x = this.XAxis.Transform(v.Key);
//                var r = new OxyRect(x - (this.symbolSize.Width / 2), this.symbolPosition - this.symbolSize.Height,
...
//                    {
//                        Series = this,
//                        DataPoint = new DataPoint(v.Key, double.NaN),
...
//            foreach (var v in this.Values)
//            {
//                if (double.IsNaN(v.Key) || v.Key < this.XAxis.ClipMinimum || v.Key > this.XAxis.ClipMaximum)
//                {
//                    continue;
//                }
...
//                if (v.Value != null)
//                {
//                    rc.DrawImage(v.Value, x, this.symbolPosition + 20, 11, 11, 1, false);
//                }
...
//                //else
//                //{
//                //    rc.DrawImage(v.Value, x, this.symbolPosition, 24, 24, 1, false);
//                //}
//            }
//        }
